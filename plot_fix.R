# Plot_fix pedigree function
#This is just very slighty modified from kinship2::plot.pedigree, so that it will plot pedigrees where affected is all 0 or NA.
plot_fix <- function (x, id = x$id, status = x$status, affected = x$affected,
